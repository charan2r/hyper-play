  ...
  const ProductCard = ({ product }) => (
    <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-all duration-300 transform hover:scale-105 relative">
      ...
      <div className="relative">
        ...
        <button
          type="button"
          className="absolute top-2 right-2 bg-white p-2 rounded-full shadow-md hover:bg-gray-50 transition-colors z-[1]"
          onClick={(e) => {
            e.preventDefault();
            e.stopPropagation();
          }}
      ...
      <section className="relative bg-gradient-to-br from-green-600 via-gray-900 to-black text-white py-16">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            {/*<button lassName="border-2 border-white text-white px-8 py-3 rounded-lg hover:bg-white hover:text-black transition-colors font-bold text-lg">
              Contact Us
            </button>*/}
          </div>
        </div>
